...
./wp-cli.phar core install --url="$DOMAIN_NAME" --title=inception --admin_user="$WORDPRESS_ADMIN_USER" --admin_password="$WORDPRESS_ADMIN_PASSWORD" --allow-root --skip-email
